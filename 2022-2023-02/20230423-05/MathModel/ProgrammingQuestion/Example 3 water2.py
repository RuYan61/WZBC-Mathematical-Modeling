...
prob = pulp.LpProblem(name='自来水输送double', sense=pulp.LpMaximize)
...
# 3. 设置目标函数 z
prob += 290 * x11 + 320 * x12 + 230 * x13 + 280 * x14 + \
        310 * x21 + 320 * x22 + 260 * x23 + 300 * x24 + \
        260 * x31 + 250 * x32 + 220 * x33

# 4. 施加约束
# 供应限制
prob += (x11 + x12 + x13 + x14 <= 100)
prob += (x21 + x22 + x23 + x24 <= 120)
prob += (x31 + x32 + x33 <= 100)
# 需求限制
