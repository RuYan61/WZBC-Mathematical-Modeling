...
# 绘制年份和增长率的折线图，设置颜色为红色，标签为"报名人数增长率（%）"
plt.plot(years[1:],growth_rates,color="red",label="报名人数增长率（%）")
...
# 设置标题为"1995年-2023年考研报名人数增长率随年份变化的折线图"
plt.title("1995年-2023年考研报名人数增长率随年份变化的折线图")
